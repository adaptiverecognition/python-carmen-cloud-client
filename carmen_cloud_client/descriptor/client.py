...
from carmen_cloud_client.descriptor.api_list_response import ApiStages
from .options import DescriptorAPIOptions
from ..models import CloudServiceRegion
from ..utils import url_concat, url_encode

class DescriptorAPIClient:
    """
    A client for interacting with the Carmen Cloud Descriptor API.
    """

    def __init__(self, options: DescriptorAPIOptions) -> None:
    ...
    def get_apis(self, detailed=False, **kwargs) -> APIStages:
        headers = self.create_headers()
        query_params = {
            'detailed': detailed,
            **kwargs
        }
        base_url = url_concat(self.api_url, f'/apis')
    ...
    def get_parametrized_api_url(self) -> str:
        return self.select_api_base_url()
